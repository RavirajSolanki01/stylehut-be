...
```
cd existing_repo
git remote add origin https://gitlab.anasource.com/raviraj/e-commerce-be.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.anasource.com/raviraj/e-commerce-be/-/settings/integrations)
